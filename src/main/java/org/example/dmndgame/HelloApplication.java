...
import org.example.dmndgame.Player.Facing;
...
public class HelloApplication extends Application {
    ...
    public void start(Stage stage) {
        caveMap = CaveMap.generate(100, 70, 0.45, 5);
    ...
    private Image loadDwarfSpriteSheet() {
        try (InputStream stream = HelloApplication.class.getResourceAsStream("/entities/miner/Walk_Base/Walk_Down-Sheet.png")) {
            if (stream == null) {
                return null;
            }
