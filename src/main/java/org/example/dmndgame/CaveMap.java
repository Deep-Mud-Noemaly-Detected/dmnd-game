...
public final class CaveMap {
    ...
    private CaveMap(int width, int height, boolean[][] walls) {
        this.width = width;
        this.height = height;
        this.walls = walls;
    }

    public static CaveMap generate(int width, int height, double wallChance, int smoothIterations) {
        ...
        return new CaveMap(width, height, grid);
    }
