...
public final class Player {
    ...
    public void update(double deltaSeconds, boolean up, boolean down, boolean left, boolean right, CaveMap map) {
        double moveX = 0;
        double moveY = 0;
    ...
    private void tryMove(double dx, double dy, CaveMap map) {
        double nextX = x + dx;
        double nextY = y + dy;
    ...
    private boolean canStand(double cx, double cy, CaveMap map) {
